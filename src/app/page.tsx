				...
				<Link href="/" passHref>
					<div className="logo-symbols">
						<div className="j-symbol">
							J<div className="ustin-text">ustin</div>
						</div>
						<div className="l-symbol">
							L<div className="e-text">e</div>
						</div>
					</div>
				</Link>
			</div>
			...
			{showNavAndIcons && (
				<>
					<div className="container">
						...
						<motion.h2
							...
							transition={{
								...
								delay: 0.5,
								ease: "easeOut",
							}} // Delayed animation for subheading
						>
							I focus on software engineering with a purpose.
							Currently studying at Texas A&M, I&apos;m passionate
							about creating to improve the world surrounding me.
						</motion.h2>
					</div>
					...
					<div ref={socialIconsRef} className="social-icons">
						...
						<a
							href="https://www.linkedin.com/in/justin-le-3a275a278/"
							target="_blank"
							rel="noopener noreferrer"
						>
							<img
						...
						<a
							href="https://github.com/Ju5t1nL3"
							target="_blank"
							rel="noopener noreferrer"
						>
							<img
